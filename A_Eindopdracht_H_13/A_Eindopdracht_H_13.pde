...
String gameEnd[] = {"Gelijkspel!", "Cirkel Wint!","Kruis Wint!"};
...
void draw() {
  ...
  }else if (gameState == 0){background(0,0,0); textAlign(CENTER, CENTER); textSize(48); text(gameEnd[win+1], width/2, height/2); x = -100; y = -100;}
...
void score(){
 ...
 text("Cirkel: " + str(player1), 20, 0);
 text("Kruis: " + str(player2), 1725, 0);
}
